...
-Dsonar.projectVersion=$PROJECT_VERSION'''
    ...
    stage('Deploy to Development') {
      steps {
        echo 'Docker Image'
        azureWebAppPublish(azureCredentialsId: 'd8363d31-c254-4794-8399-24d0368cc960', appName: 'silicusphpdemo', resourceGroup: 'silicusResourceGroup', publishType: 'docker', dockerFilePath: 'Dockerfile', dockerImageTag: '2', dockerImageName: 'silicus.azurecr.io/ajaydemo', dockerRegistryEndpoint: [credentialsId: 'e0cf6c73-37f0-43dc-924b-0cdb83324f38', url: 'https://silicus.azurecr.io'], filePath: './')
